...
use demo\Types\Address;
use demo\Types\Block;
use demo\Types\BlockNumber;
use demo\Types\Transaction;
use demo\Types\TransactionHash;
use demo\Types\TransactionInfo;
use demo\Types\Wei;
...
class Eth extends AbstractMethods
{
    ...
    public function getBalance(Address $address, BlockNumber $blockNumber): Wei
    {
        ...
        return new Wei(base_convert($response->getRpcResult(), 16, 10));
